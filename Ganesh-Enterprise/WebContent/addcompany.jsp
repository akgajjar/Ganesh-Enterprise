...
<body
	...
	<span id="tops"></span>
			...
			<div class="h">
				<h1>
					<b><font color="white">Add New Company</font></b>
				</h1>
			</div>
			<br />
			...
			<div class="w3l-main">
				<div class="w3l-from">
					<form action="billcontroller" method="post"
						...
						<div class="w3l-user">
							<label class="head">Company Name<span class="w3l-star">
									* </span></label> <input type="text" name="companyname" id="companyname"
								autocomplete="off"> <span id="a1"></span>
						</div>
						
						<div class="w3l-user">
							<label class="head">Company Address<span class="w3l-star">
									* </span></label> <input type="text" name="companyadd" id="companyadd"
								autocomplete="off"> <span id="a1"></span>
						</div>
						<div class="w3l-user">
							<label class="head">Company Phone<span class="w3l-star">
									* </span></label> <input type="text" name="companyphone" id="companyphone"
								autocomplete="off"> <span id="a1"></span>
						</div>
						<div class="w3l-user">
							<label class="head">Company GST No<span class="w3l-star">
									* </span></label> <input type="text" name="companygstno" id="companygstno"
								autocomplete="off"> <span id="a1"></span>
						</div>
						<div class="w3l-user">
							<label class="head">Company's Bank Name<span class="w3l-star">
									* </span></label> <input type="text" name="companybankname" id="companybankname"
								autocomplete="off"> <span id="a1"></span>
						</div>
						<div class="w3l-user">
							<label class="head">Company's Bank Address<span class="w3l-star">
									* </span></label> <input type="text" name="companybankadd" id="companybankadd"
								autocomplete="off"> <span id="a1"></span>
						</div>
						<div class="w3l-user">
							<label class="head">Company's Bank IFSC Code<span class="w3l-star">
									* </span></label> <input type="text" name="companyifsc" id="companyifsc"
								autocomplete="off"> <span id="a1"></span>
						</div>
