...
<body style="background: url(images/back2.jpeg) no-repeat; background-size: cover; font-family: 'PT Sans', sans-serif; background-attachment: fixed; background-position: center;">
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li><a href="#catsubmenu" data-toggle="collapse"
					...
					<ul class="collapse list-unstyled" id="catsubmenu">
						<li><a href="newcat.jsp">Add Category</a></li>
              ...
              <li><a href="#productsubmenu" data-toggle="collapse"
					aria-expanded="false"> <i class="fas fa-laptop"></i> Products <i
						class="fas fa-angle-down fa-pull-right"></i>
				</a>
					<ul class="collapse list-unstyled" id="productsubmenu">
						<li><a href="newproduct.jsp">Add New Products</a></li>
						<li><a href="showallproducts.jsp">Show All Products</a></li>

					</ul></li>
					
				 <li><a href="#billsubmenu" data-toggle="collapse"
					aria-expanded="false"> <i class="fas fa-laptop"></i>Bill<i
						class="fas fa-angle-down fa-pull-right"></i>
				</a>
					<ul class="collapse list-unstyled" id="billsubmenu">
						<li><a href="salesbill.jsp">Create Sales Bill</a></li>
						<li><a href="showallproducts.jsp">Show All Products</a></li>
