<%@page import="com.bean.category_product_masterbean"%>
...
<body
	...
	<span id="tops"></span>
			...
			<%
	category_mastermodel c=new category_mastermodel();
	List<category_masterbean> list=c.getallcategories();
	
	category_product_mastermodel m=new category_product_mastermodel();
	category_product_masterbean bean=m.getproductbyId(Integer.parseInt(request.getParameter("id")));
...
%>
			...
			<div class="w3l-main">
				<div class="w3l-from">
					<form action="category_product_mastercontroller" method="post"
						name="catadd" id="catadd" >

					<input type="hidden" value="<%=bean.getCP_Id() %>" name="pid">
					<input type="hidden" value="<%=bean.getCP_Display() %>" name="pdisplay">
					
						<div class="w3l-user">
							<label class="head">Product Name<span class="w3l-star">
									* </span></label> <input type="text" name="pname" id="pname"
							value="<%=bean.getCP_Name() %>"	autocomplete="off"> <span id="a1"></span>
						</div>

						<div class="w3l-right">
							<label class="w3l-set2">Product Description<span
								class="w3l-star"> * </span></label>
							<textarea name="description" ><%=bean.getCP_Desciption() %></textarea>
						</div>
						
						<div class="w3l-user">
							<label class="head">Product Size<span class="w3l-star">
									* </span></label> <input type="text" name="psize" value="<%=bean.getCP_Size() %>" id="psize"
								autocomplete="off"> <span id="a1"></span>
						</div>
						
						<div class="w3l-user">
							<label class="head">Product Old Prize<span class="w3l-star">
									* </span></label> <input type="text" name="poldprize" id="poldprize" value="<%=bean.getCP_Old_Prize() %>"
								autocomplete="off"> <span id="a1"></span>
						</div>
						
						<div class="w3l-user">
							<label class="head">Product New Prize<span class="w3l-star">
									* </span></label> <input type="text" name="pnewprize" id="pnewprize" value="<%=bean.getCP_Prize() %>"
								autocomplete="off"> <span id="a1"></span>
						</div>
