...
<h1> Show All Products</h1>
	<table class="table">
		...
		<tr>
				<th class="td">Category Id</th>
				<th class="td">Category Name</th>
				<th class="td">Category Description</th>
				<th class="td">Parent Category</th>
				<th class="td">Update Category</th>
		</tr>
		
		
		<%
		for(category_masterbean b:list)
		{
			String name=c.getcatbyId(b.getC_Parent_Id()).getC_Name();
			%>
			<tr>
				<td class="td"><%=b.getC_Id() %></td>
				<td class="td"><%=b.getC_Name() %></td>
				<td class="td"><%=b.getC_Description()%></td>
				<td class="td"><%=name %></td>
				<td class="td"><form action="category_mastercontroller" method="post">
								<input type="hidden" name="id" value="<%=b.getC_Id()%>">
