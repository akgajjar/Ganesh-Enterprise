...
<body
	...
	<span id="tops"></span>
			...
			List<category_masterbean> list=c.getallcategoriesByProductid(id);
...
%>
			...
			<div class="h">
				<h1>
					<b><font color="white">Remove From Category</font></b>
				</h1>
			</div>
			<br />
				...
				<div class="w3l-from">
					...
					<div class="w3l-options2" style="width: 100%;">
							<label class="head">Category Name<span class="w3l-star">
									* </span></label> <select class="category2" id="cat"
								name="cat" >
