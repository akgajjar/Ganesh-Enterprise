<%@page import="com.bean.clientbin"%>
<%@page import="com.bean.company_masterbean"%>
<%@page import="com.model.billmodel"%>
<%@page import="com.bean.bill_masterbean"%>
...
<body
	...
	<span id="tops"></span>
			...
			<%
	billmodel c=new billmodel();
	List<clientbin> list=c.getallclients();
%>
			...
			<div class="h">
				<h1>
					<b><font color="white">Create Sales Bill</font></b>
				</h1>
			</div>
			<br />
					...
					<form action="billcontroller" method="post"
						...
						<div class="w3l-options2" style="width: 100%;">
							<label class="head">Company Name<span class="w3l-star">
									* </span></label> <select class="category2" id="client"
								name="client" >
								<option value="0">--Select Client--</option>
									
									<%
										for( clientbin bean :list)
										{
											%>
											<option value="<%=bean.getBI_Id()%>"><%=bean.getBI_Client_Name()%></option>
											<%
										}
									%>
