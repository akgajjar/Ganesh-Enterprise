...
<body
	...
	category_masterbean b=c.getcatbyId(id);
	category_masterbean parent=c.getcatbyId(b.getC_Parent_Id());
%>
			...
			<div class="h">
				<h1>
					<b><font color="white">Add New Category</font></b>
				</h1>
			</div>
			<br />
			...
			<div class="w3l-main">
				<div class="w3l-from">
					<form action="category_mastercontroller" method="post"
						name="catadd" id="catadd" >

						<input type="hidden" name="id" id="id" value="<%=id%>">

						<div class="w3l-user">
							<label class="head">Category Name<span class="w3l-star">
									* </span></label> <input type="text" name="cname" id="cname" value="<%=b.getC_Name() %>"
								autocomplete="off"> <span id="a1"></span>
						</div>

						<div class="w3l-right">
							<label class="w3l-set2">Category Description<span
								class="w3l-star"> * </span></label>
							<textarea name="description"><%=b.getC_Description() %></textarea>
						</div>
							
							
						<div class="w3l-options2" style="width: 100%;">
							<label class="head">Parent Category<span class="w3l-star">
									* </span></label> <select class="category2" id="parentcat"
								name="parentcat" >
								<option value="<%=parent.getC_Id()%>" selected><%= parent.getC_Name()%></option>
									
									<%
										for(category_masterbean bean :list)
										{
											if((parent.getC_Id()!=bean.getC_Id()) && bean.getC_Id()!=b.getC_Id())
											{
											%>
											<option value="<%=bean.getC_Id()%>"><%=bean.getC_Name() %></option>
											<%
											}
										}
									%>
