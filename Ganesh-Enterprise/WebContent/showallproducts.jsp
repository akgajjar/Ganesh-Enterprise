...
<body
	...
	<span id="tops"></span>
			...
			<%
		category_product_mastermodel c =new   category_product_mastermodel();
		List<category_product_masterbean> list=c.getallproducts();
%>
...
<h1> Show All Products</h1>
	<table class="table">
		...
		<tr>
				...
				<th class="td">Product Description</th>
				<th class="td">Product Size</th>
				<th class="td">Product Old Prize</th>
				<th class="td">Product New Prize</th>
				<th class="td">product Display</th>	
				<th class="td">Add Into Category</th>
				<th class="td">Remove From Category</th>
				<th class="td">Change Display Status</th>
				<th class="td">Update Product</th>
				<th class="td">Add Images</th>
				<th class="td">Remove Images</th>
				<th class="td">Delete product</th>
		</tr>
		
		
		<%
		for(category_product_masterbean b:list)
		{
			%>
			<tr>
				<td class="td"><%=b.getCP_Id() %></td>
				<td class="td"><%=b.getCP_Name() %></td>
				<td class="td"><%=b.getCP_Desciption() %></td>
				<td class="td"><%=b.getCP_Size() %></td>
				<td class="td"><%=b.getCP_Old_Prize() %></td>
				<td class="td"><%=b.getCP_Prize() %></td>
				<td class="td"><%=b.getCP_Display() %></td>
				<td class="td"><form action="category_product_mastercontroller" method="post">
								<input type="hidden" name="id" value="<%=b.getCP_Id()%>">
				...
				<td class="td"><form action="category_product_mastercontroller" method="post">
								<input type="hidden" name="id" value="<%=b.getCP_Id()%>">
								<input type="hidden" name="display" value="<%=b.getCP_Display()%>">
				...
				<td class="td"><form action="product_imagescontroller" method="post">
								<input type="hidden" name="id" value="<%=b.getCP_Id()%>">
										<input type="submit" value="Add" name="action">	
								</form></td>
				<td class="td"><form action="product_imagescontroller" method="post">
