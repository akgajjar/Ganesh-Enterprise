...
<body
	...
	List<company_masterbean> list=c.getallcompanies();
%>
					...
					<form action="billcontroller" method="post"
						...
						<div class="w3l-options2" style="width: 100%;">
							<label class="head">Company Name<span class="w3l-star">
									* </span></label> <select class="category2" id="company"
								name="company" >
								<option value="0">--Select Company--</option>
									
									<%
										for( company_masterbean bean :list)
										{
											%>
											<option value="<%=bean.getCompany_Id()%>"><%=bean.getCompany_Name()%></option>
											<%
										}
									%>
